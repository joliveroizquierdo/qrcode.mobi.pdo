...
$config=new Config();
$laboratorios=$config->getLaboratorios();
?>
<!DOCTYPE html>
<html lang="es">
<head>
		...
		<div data-role="page" id="departamentos">
		   ...
		   <div data-role="content">
				<ul data-role="listview">
					...
					<li><a href="descripcionL.php?id=<?php echo $lab['id'];?>"><?php echo $lab['nombre'];?></a></li>
					<?php endforeach;?>
				</ul>
		   </div>
		   <footer data-role="footer"  data-position="fixed">
			<div data-role="navbar">
				<ul>
					...
					<li><a href="#" class="ui-btn-active ui-state-persist" data-iconpos="top" data-iconpos="top"  data-icon="grid">Laboratorios</a></li>
